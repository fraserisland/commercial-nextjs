...
const getFormattedNumberLabel = (label: string, attribute) => {
  ...
  return (
    <div className='bg-gray-100'>
      <div className='mx-auto max-w-7xl py-3 px-4 sm:flex sm:items-center sm:px-6 lg:px-8'>
        <h3 className='py-1 nowrap text-xs font-semibold uppercase tracking-wide text-gray-500'>
          APPLIED FILTERS
        ...
        {canRefine && (
          <button
            ...
            className='py-1 text-xs nowrap font-semibold tracking-wide'
