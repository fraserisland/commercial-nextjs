...
const PropertyManagement = () => (
  <Main meta={<Meta title='Property Mangement - Commercial 1 GC' description='At Commercial 1 Property Management we specialise in Commercial and
  Industrial properties and are committed to ensuring you are provided with
  the highest level of service. Our team is experienced in overseeing
